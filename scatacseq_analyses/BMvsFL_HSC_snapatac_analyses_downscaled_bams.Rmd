...
x.sp3.sample_peaks = createPmat(x.sp3.sample_peaks, peak.gr,  do.par = TRUE, num.cores = 8)
...
idy.ls <- list(idyFLHSC, idyABMHSCvsFL, idyCD41neg, idyCD41pos, idyMkP, idyABMHSCvsMkP)
