...
# Read in peaks in promoters only
setwd("/mnt/data/common/jonas/scatac/191204_yuan_FLvsBM_HSC_BHHTF7DRXX/snap_atac_analysis/peaks_from_sample.in_promoters")
...
x.sp3.promoter_peaks <- x.sp3.sample_peaks
...
peak.matrix <- as(object = x.sp3.promoter_peaks@pmat, Class = 'matrix')
peak.dataframe <- as.data.frame(t(peak.matrix))

#assign column names corresponding to the cell barcodes.
colnames(peak.dataframe) <- x.sp3.promoter_peaks@sample
...
sce$snap_cluster <- x.sp3.promoter_peaks@cluster
...
save.image("/mnt/data/common/jonas/scatac/191204_yuan_FLvsBM_HSC_BHHTF7DRXX/snap_atac_analysis/peaks_from_sample_in_promoters/BMvsFL_HSC_snapatac_analyses_promoter_peaks_only.RData")
...
sce2<- runUMAP( sce2 )
sce2$cell_type <- x.sp3.promoter_peaks@sample
sce2$snap_cluster <- x.sp3.promoter_peaks@cluster
...
ggplot(as.data.frame(colData(sce2)), aes(x = sce2$slingPseudotime_1, y = cell_type, 
    ...
    ggtitle("Cells ordered by Slingshot pseudotime var_top10000_promoter_peaks")

ggsave(filename = "slingshot_pseudotime_order_cell_type_var_var_top10000_promoter_peaks.pdf", device = "pdf",path = "/mnt/data/common/jonas/scatac/191204_yuan_FLvsBM_HSC_BHHTF7DRXX/snap_atac_analysis/peaks_from_sample.in_promoters/", units = c("cm"), width = 20, height = 15)
...
ggsave(filename = "slingshot_pseudotime_order_snap_cluster_var_top10000_promoter_peaks.pdf", device = "pdf",path = "/mnt/data/common/jonas/scatac/191204_yuan_FLvsBM_HSC_BHHTF7DRXX/snap_atac_analysis/peaks_from_sample.in_promoters/", units = c("cm"), width = 20, height = 15)
...
x.sp3.promoter_peaks_mouse <- x.sp3.promoter_peaks

#To get a complete list. Run this against both mouse and human and combine them in some way.
x.sp3.promoter_peaks_mouse@mmat = runChromVAR(
    obj=x.sp3.promoter_peaks_mouse,
    input.mat="pmat",
...
x.sp3.promoter_peaks_human <- x.sp3.promoter_peaks

x.sp3.promoter_peaks_human@mmat = runChromVAR(
    obj=x.sp3.promoter_peaks_human,
    input.mat="pmat",
    genome=BSgenome.Mmusculus.UCSC.mm10,
    min.count=10,
...
x.sp3.promoter_peaks_mmat_combined <- x.sp3.promoter_peaks
x.sp3.promoter_peaks_mmat_combined@mmat <- cbind(x.sp3.promoter_peaks_mouse@mmat,x.sp3.promoter_peaks_human@mmat)
rm(x.sp3.promoter_peaks_mouse)
rm(x.sp3.promoter_peaks_human)
...
dat = data.frame(x=plot_order_samples, y=x.sp3.promoter_peaks_mmat_combined@mmat[,motif_i]);
...
for (i in 1:length(colnames(x.sp3.promoter_peaks_mmat_combined@mmat)) ) {

  motif_i = colnames(x.sp3.promoter_peaks_mmat_combined@mmat)[i];
  ...
  ggsave(filename = paste(motif_i,"chromVAR_enrichment_per_sample_promoter_peaks_only.pdf",sep = "."), device = "pdf", dpi = 150, units = c("cm"), width = 10, height = 9)
}
...
pseudotime_order$cluster <- x.sp3.promoter_peaks_mmat_combined@cluster[pseudotime_order$index]
pseudotime_order$sample <- x.sp3.promoter_peaks_mmat_combined@sample[pseudotime_order$index]
#Bring out the motif_matrix
motif_matrix <-as.data.frame(t(x.sp3.promoter_peaks_mmat_combined@mmat))
...
colnames(x.sp3.promoter_peaks_mmat_combined@mmat)[211]<-"MA0140.2_GATA1_TAL1"

plotFeatureSingle( obj=x.sp3.promoter_peaks_mmat_combined,feature.value=x.sp3.promoter_peaks_mmat_combined@mmat[,'MA0841.1_NFE2'], method="umap",  main='MA0841.1_NFE2', point.size=0.1,  point.shape=19 , quantiles=c(0.2, 0.8) )

plotFeatureSingle( obj=x.sp3.promoter_peaks_mmat_combined,feature.value=x.sp3.promoter_peaks_mmat_combined@mmat[,'MA0035.3_Gata1'], method="umap",  main='MA0035.3_Gata1', point.size=0.1,  point.shape=19 , quantiles=c(0.2, 0.8) )

plotFeatureSingle( obj=x.sp3.promoter_peaks_mmat_combined,feature.value=x.sp3.promoter_peaks_mmat_combined@mmat[,'MA0795.1_SMAD3'], method="umap",  main='MA0795.1_SMAD3', point.size=0.1,  point.shape=19 , quantiles=c(0.2, 0.8) )

plotFeatureSingle( obj=x.sp3.promoter_peaks_mmat_combined,feature.value=x.sp3.promoter_peaks_mmat_combined@mmat[,'MA0080.4_SPI1'], method="umap",  main='MA0080.4_SPI1', point.size=0.1,  point.shape=19 , quantiles=c(0.2, 0.8) )

plotFeatureSingle( obj=x.sp3.promoter_peaks_mmat_combined,feature.value=x.sp3.promoter_peaks_mmat_combined@mmat[,'MA0140.2_GATA1_TAL1'], method="umap",  main='MA0140.2_GATA1_TAL1', point.size=0.1,  point.shape=19 , quantiles=c(0.2, 0.8) )

plotFeatureSingle( obj=x.sp3.promoter_peaks_mmat_combined,feature.value=x.sp3.promoter_peaks_mmat_combined@mmat[,'MA0002.2_RUNX1'], method="umap",  main='MA0002.2_RUNX1', point.size=0.1,  point.shape=19 , quantiles=c(0.2, 0.8))

plotFeatureSingle( obj=x.sp3.promoter_peaks_mmat_combined,feature.value=x.sp3.promoter_peaks_mmat_combined@mmat[,'MA0594.1_Hoxa9'], method="umap",  main='MA0594.1_Hoxa9', point.size=0.1,  point.shape=19 , quantiles=c(0.2, 0.8))

plotFeatureSingle( obj=x.sp3.promoter_peaks_mmat_combined,feature.value=x.sp3.promoter_peaks_mmat_combined@mmat[,'MA0102.3_CEBPA'], method="umap",  main='MA0102.3_CEBPA', point.size=0.1,  point.shape=19 , quantiles=c(0.2, 0.8))

plotFeatureSingle( obj=x.sp3.promoter_peaks_mmat_combined,feature.value=x.sp3.promoter_peaks_mmat_combined@mmat[,'MA0139.1_CTCF'], method="umap",  main='MA0139.1_CTCF', point.size=0.1,  point.shape=19 , quantiles=c(0.2, 0.8))
```
